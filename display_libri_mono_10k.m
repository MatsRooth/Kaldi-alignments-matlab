...
alifile = '/Volumes/NONAME/speech/librispeech/s5/exp/mono_ali_10k/ali.all-t.gz';
wavscp = '/Volumes/NONAME/speech/librispeech/s5/data/train_10k/wav.scp';
model = '/Volumes/NONAME/speech/librispeech/s5/exp/mono_ali_10k/final.mdl';
phones = '/Volumes/NONAME/speech/librispeech/s5/data/lang_nosp/phones.txt';
% 5k training data
transcript = '/Volumes/NONAME/speech/librispeech/s5/data/train_10k/text';
